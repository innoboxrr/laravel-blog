...
namespace Innoboxrr\LaravelBlog\Notifications\BlogSubscriber;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\LaravelBlog\Exports\BlogSubscribersExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new BlogSubscribersExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | BlogSubscriber export notification';
    }
