...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\LaravelBlog\Models\BlogCategory,id',
    ...
    public function handle()
    {
         ...
         $blogCategory = ($this->id) ? 
            BlogCategory::findOrFail($this->id) : 
            app(BlogCategory::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $blogCategory),
        ]);
