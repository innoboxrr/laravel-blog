...
namespace Innoboxrr\LaravelBlog\Notifications\BlogPost;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\LaravelBlog\Exports\BlogPostsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new BlogPostsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | BlogPost export notification';
    }
