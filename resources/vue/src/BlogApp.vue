                ...
                <div class="border-b border-gray-200 px-4 py-2 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
                    ...
                    <div class="mt-4 flex sm:ml-4 sm:mt-0">
                        <router-link 
                            ...
                            type="button" 
                            class="order-1 ml-3 inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:order-[0] sm:ml-0 hover:text-gray-700">
                            {{ __blog('New category') }}
                        </router-link>
                        <router-link 
                            :to="{
