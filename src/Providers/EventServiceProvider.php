...
class EventServiceProvider extends ServiceProvider
{
    ...
    {
        $cacheKey = 'laravel_blog_events_and_observers';
    ...
    protected function customDiscoverEvents()
    {
        ...
        $namespace = 'Innoboxrr\LaravelBlog\Http\Events\\';
    ...
    protected function customDiscoverObservers()
    {
        ...
        $namespaceModel = 'Innoboxrr\LaravelBlog\Models\\';
        $namespaceObserver = 'Innoboxrr\LaravelBlog\Observers\\';
