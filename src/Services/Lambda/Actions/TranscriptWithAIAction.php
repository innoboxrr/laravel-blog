...
class TranscriptWithAIAction
{
    ...
    protected function process()
    {
        ...
        // Variante para procesar video o audio
        $mp3S3Url = $mediaType === 'video'
            ? $this->convertVideoToAudio($this->data['payload']['s3Url'])
            : $this->data['payload']['s3Url'];
