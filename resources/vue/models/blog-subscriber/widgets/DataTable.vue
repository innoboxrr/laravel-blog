<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="blogSubscriberExternalFilters"
...
<script>
	...
	import FilterForm from '@blogModels/blog-subscriber/forms/FilterForm.vue'
	import * as model from '@blogModels/blog-subscriber' 
