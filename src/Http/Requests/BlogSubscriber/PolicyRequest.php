...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\LaravelBlog\Models\BlogSubscriber,id',
    ...
    public function handle()
    {
         ...
         $blogSubscriber = ($this->id) ? 
            BlogSubscriber::findOrFail($this->id) : 
            app(BlogSubscriber::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $blogSubscriber),
        ]);
