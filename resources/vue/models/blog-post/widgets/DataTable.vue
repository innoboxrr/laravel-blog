<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="blogPostExternalFilters"
...
<script>
	...
	import FilterForm from '@blogModels/blog-post/forms/FilterForm.vue'
	import * as model from '@blogModels/blog-post' 
