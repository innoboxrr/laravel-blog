<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="blogCategoryExternalFilters"
...
<script>
	...
	import FilterForm from '@blogModels/blog-category/forms/FilterForm.vue'
	import * as model from '@blogModels/blog-category' 
