<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="blogTagExternalFilters"
...
<script>
	...
	import FilterForm from '@blogModels/blog-tag/forms/FilterForm.vue'
	import * as model from '@blogModels/blog-tag' 
