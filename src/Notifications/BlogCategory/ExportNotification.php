...
namespace Innoboxrr\LaravelBlog\Notifications\BlogCategory;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\LaravelBlog\Exports\BlogCategoriesExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new BlogCategoriesExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | BlogCategory export notification';
    }
